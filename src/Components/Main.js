...
import { getPattern } from '../../src/Publics/Redux/action/board';
...
class Drum extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            pattern: [],
            isNow: 0,
            button: this.props.navigation.getParam('button'),
            time: null,
            id: '',
            token: null,
        ...
        return (
            <>
                ...
                <View style={styles.container}>
                    <Image style={{ width: 370, height: 230, position: 'absolute', top: 370 }} source={require('../Assets/img/bg.jpg')} />
